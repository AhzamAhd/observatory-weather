...
def upsert_weather_readings(data, now):
    ...
    for record in data:
        ...
        rows.append((
            ...
            record.get("temp_700hpa"),
            record.get("temp_600hpa"),
            record.get("temp_500hpa"),
            record.get("geopot_850hpa"),
            record.get("geopot_700hpa"),
            record.get("geopot_600hpa"),
            record.get("geopot_500hpa"),
            record.get("wind_850hpa"),
            record.get("wind_700hpa"),
            record.get("wind_600hpa"),
            record.get("wind_500hpa"),
    ...
    if rows:
        execute_many("""
            INSERT INTO weather_readings (
                ...
                observation_score,
                temp_850hpa,      temp_700hpa,
                temp_600hpa,      temp_500hpa,
                geopot_850hpa,    geopot_700hpa,
                geopot_600hpa,    geopot_500hpa,
            ...
            DO UPDATE SET
                ...
                temp_700hpa       = EXCLUDED.temp_700hpa,
                temp_600hpa       = EXCLUDED.temp_600hpa,
                temp_500hpa       = EXCLUDED.temp_500hpa,
                geopot_850hpa     = EXCLUDED.geopot_850hpa,
                geopot_700hpa     = EXCLUDED.geopot_700hpa,
                geopot_600hpa     = EXCLUDED.geopot_600hpa,
                geopot_500hpa     = EXCLUDED.geopot_500hpa,
                wind_850hpa       = EXCLUDED.wind_850hpa,
                wind_700hpa       = EXCLUDED.wind_700hpa,
                wind_600hpa       = EXCLUDED.wind_600hpa,
